 ...
 */
package com.squirrel.springcloud.squirrel.gen.web.dao;
...
/**
 * 代码生成table column 表Mapper接口
 * @author JoinHan
 * @version 2017-09-06
 */
@Mapper
public interface GenTableColumnMapper extends BaseMapper<GenTableColumn,GenTableColumnExample> {
