 ...
 */
package com.squirrel.springcloud.squirrel.modules.sys.controller;

import com.squirrel.springcloud.squirrel.common.base.BaseController;
import com.squirrel.springcloud.squirrel.common.base.BaseOpMsg;
import com.squirrel.springcloud.squirrel.common.status.StatusCode;
 ...
 */
@Controller
@RequestMapping(value = "${app.adminPath}/sys/sysUser")
